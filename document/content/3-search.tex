...
All figures and tables in this report are generated by the accompanying pipeline (\texttt{make generate}). An interactive explorer that reproduces these searches, including the filter coefficients, decisional weights, and distance criteria used above — is publicly available at \url{https://mjthatch.github.io/SPHINCS-Parameters/site/}.